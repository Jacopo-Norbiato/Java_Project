...
import com.example.model.CheckNewRequest;
import com.example.model.Email;
import com.example.model.ReceiveReq;
...
class EmailChecker implements Runnable {
    ...
    public void run() {
        try {
             ...
             * utilizzando Connection.sendRequest() per open/close del socket
             * quando viene inviata la request
             */

             CheckNewRequest request = new CheckNewRequest(connection.getAccount().getEmail(), lastEmailId);
            ...
            if (response instanceof List) {
                ...
                ReceiveReq receivedEmailRequest = new ReceiveReq(connection.getAccount().getEmail());
                try {
